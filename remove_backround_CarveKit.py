...
class ImageProcessor:
    ...
    def remove_backround(self, file):
        interface = HiInterface(object_type="object",  # Can be "object" or "hairs-like".
                                ...
                                fp16=False)
        images_without_background = interface([file])
        images_without_background_png = images_without_background[0]

        return images_without_background_png
    ...
    def process_image(self, file_path, new_filename):
        ...
        output = self.remove_backround(file_path)
